  ...
  return (
    <div className="bg-slate-800 shadow-lg rounded-lg p-5 transition-all hover:shadow-sky-500/30">
      ...
      <div className="grid grid-cols-2 gap-x-4 text-sm mb-3">
        <p className="text-slate-400"><strong className="text-slate-300">Start:</strong> {formatDate(task.startDate)}</p>
        <p className="text-slate-400"><strong className="text-slate-300">End:</strong> {formatDate(task.endDate)}</p>
      </div>
       <div className="text-sm mb-4">
        <p className="text-slate-400"><strong className="text-slate-300">Depends on:</strong> {getDependencyNames(task.dependencies)}</p>
      </div>
